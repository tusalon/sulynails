...
const CACHE_NAME = 'sulynails-v49';
const urlsToCache = [
  '/sulynails/',
  '/sulynails/index.html',
  '/sulynails/admin.html',
  '/sulynails/admin-login.html',
  '/sulynails/calendar.html',
  '/sulynails/setup-wizard.html',
  '/sulynails/editar-negocio.html',
  '/sulynails/manifest.json',
  '/sulynails/icons/icon-72x72.png',
  '/sulynails/icons/icon-96x96.png',
  '/sulynails/icons/icon-128x128.png',
  '/sulynails/icons/icon-144x144.png',
  ...
  '/sulynails/utils/push-config.js',
  '/sulynails/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/sulynails/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/sulynails/icons/icon-192x192.png',
    badge: '/sulynails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/sulynails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/sulynails/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Suly.nails');
